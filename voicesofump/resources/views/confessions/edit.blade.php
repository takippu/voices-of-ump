...
@if(session()->has('message'))
    <div class="flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3 mb-7" role="alert">
        ...
        <p>Successfully edit your confession.</p>
    </div>
    @endif
<div>
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
      <div class="md:col-span-1">
        <div class="px-4 sm:px-0">
          ...
          <h3 class="text-lg font-medium leading-6 text-gray-900">Edit your confession</h3>
          ...
          <div class="shadow sm:overflow-hidden sm:rounded-md">
            <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
              <div class="grid grid-cols-3 gap-6">
                <div class="col-span-3 sm:col-span-2">
                  ...
                  <div class="mt-1 flex rounded-md shadow-sm">
                    ...
                    <input type="text" name="title" id="title" class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Write a title..." value="{{$confessions->title}}">
              ...
              <div>
                ...
                <div class="mt-1">
                  <textarea id="content" name="content" rows="10" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="It was a sunny day....">{{$confessions->content}}</textarea>
                  @error('content')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                  @enderror
                </div>
            ...
            <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
              ...
              <form action="{{route('confessions.destroy', $confessions->id)}}" method="POST">
                @csrf
                @method('DELETE')    
