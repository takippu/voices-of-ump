      ...
      >
        ...
        >
          <div class="md:flex-shrink-0">
             ...
             <img class="object-fill w-full rounded-lg rounded-b-none md:h-56" src="{{asset('assets/img-posts/'.rand(1,10).'.png')}}" alt="">

             @else
             <img class="object-fill w-full rounded-lg rounded-b-none md:h-56" src="{{$post->image_path}}" alt="">
             @endif
