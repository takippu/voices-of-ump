                        ...
                        <div class="mt-7 overflow-auto rounded-lg shadow">
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    @forelse ($petitions_from_user_for_admin as $conf)
...
{{--                                         <td>
                            ...
                            {{ $petitions_from_user_for_admin->appends(['confessions'=> $confessions_from_user_for_admin->currentPage()])->links('pagination::tailwind') }}
                        </div>
                    </div>
                </div>
