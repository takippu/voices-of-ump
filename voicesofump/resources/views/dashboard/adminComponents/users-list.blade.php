                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    ...
                                    <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                                        ...
                                        <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <span class="text-base font-medium text-center leading-none text-gray-700 mr-1 hover:text-blue-600 truncate">{{$conf->email ?? 'error: email not found'}}</span>
                                            </div>
                                        </td>
                                        <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <span class="text-base font-medium text-center leading-none text-gray-700 mr-1 hover:text-blue-600 truncate">{{$conf->name}}</span>
                                            </div>
                                        </td>
                                        <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                                            <div class="flex items-center">
                                        ...
                                        <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <span class="text-base font-medium text-center leading-none text-gray-700 mr-1 hover:text-blue-600 truncate">
                                                    @if($conf->roles == '0')
                                                        Administrator
                                                    @else 
                                                        User
